...
export default function SellerLogin() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:5000/sellerlogin', formData); // Modified route to /sellerlogin
      ...
      // Redirect the seller to another page or update the UI as needed
